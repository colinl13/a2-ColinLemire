...
The CSS positioning technique I used was the grid technique. I decided on this instead of the flex box because the website was simple enough that a flexbox was not needed. The execution of this technique was done by creating a container for the form section and the results section and making them both items of the grid.
